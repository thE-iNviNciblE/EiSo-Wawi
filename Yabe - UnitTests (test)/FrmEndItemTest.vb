...
'''<summary>
'''Dies ist eine Testklasse für "FrmEndItemTest" und soll
'''alle FrmEndItemTest Komponententests enthalten.
'''</summary>
<TestClass()> _
Public Class FrmEndItemTest
...
#End Region
    ...
    '''<summary>
    '''Ein Test für "FrmEndItem-Konstruktor"
    '''</summary>
    <TestMethod()> _
    Public Sub FrmEndItemConstructorTest()
        Dim target As FrmEndItem = New FrmEndItem
        Assert.Inconclusive("TODO: Code zum Überprüfen des Ziels implementieren")
    End Sub

    '''<summary>
    '''Ein Test für "BtnEndItem_Click"
    '''</summary>
    <TestMethod(), _
     DeploymentItem("YabE.exe")> _
    Public Sub BtnEndItem_ClickTest()
        Dim target As FrmEndItem_Accessor = New FrmEndItem_Accessor ' TODO: Passenden Wert initialisieren
        ...
        target.BtnEndItem_Click(sender, e)
    ...
    '''<summary>
    '''Ein Test für "FrmEndItem_Load"
    '''</summary>
    <TestMethod(), _
     DeploymentItem("YabE.exe")> _
    Public Sub FrmEndItem_LoadTest()
        Dim target As FrmEndItem_Accessor = New FrmEndItem_Accessor ' TODO: Passenden Wert initialisieren
        Dim sender As Object = Nothing ' TODO: Passenden Wert initialisieren
        Dim e As EventArgs = Nothing ' TODO: Passenden Wert initialisieren
        target.FrmEndItem_Load(sender, e)
        Assert.Inconclusive("Eine Methode, die keinen Wert zurückgibt, kann nicht überprüft werden.")
    End Sub
    ...
    '''<summary>
    '''Ein Test für "BtnEndItem"
    '''</summary>
    <TestMethod()> _
    Public Sub BtnEndItemTest()
        Dim target As FrmEndItem = New FrmEndItem ' TODO: Passenden Wert initialisieren
        Dim expected As Button = Nothing ' TODO: Passenden Wert initialisieren
        Dim actual As Button
        target.BtnEndItem = expected
        actual = target.BtnEndItem
        Assert.AreEqual(expected, actual)
        Assert.Inconclusive("Überprüfen Sie die Richtigkeit dieser Testmethode.")
    End Sub

    '''<summary>
    '''Ein Test für "CboReason"
    '''</summary>
    <TestMethod()> _
    Public Sub CboReasonTest()
        Dim target As FrmEndItem = New FrmEndItem ' TODO: Passenden Wert initialisieren
        Dim expected As ComboBox = Nothing ' TODO: Passenden Wert initialisieren
        Dim actual As ComboBox
        target.CboReason = expected
        actual = target.CboReason
        Assert.AreEqual(expected, actual)
        Assert.Inconclusive("Überprüfen Sie die Richtigkeit dieser Testmethode.")
    End Sub
    ...
    '''<summary>
    '''Ein Test für "LblReason"
    '''</summary>
    <TestMethod()> _
    Public Sub LblReasonTest()
        Dim target As FrmEndItem = New FrmEndItem ' TODO: Passenden Wert initialisieren
        Dim expected As Label = Nothing ' TODO: Passenden Wert initialisieren
        Dim actual As Label
        target.LblReason = expected
        actual = target.LblReason
        Assert.AreEqual(expected, actual)
        Assert.Inconclusive("Überprüfen Sie die Richtigkeit dieser Testmethode.")
    End Sub
