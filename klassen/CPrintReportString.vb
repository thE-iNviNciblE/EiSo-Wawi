   ...
   Public Sub PrintOrPreview(ByVal CPL As CharsPerLine, _
      ...
      Try
         ...
         oUtil2 = New CUtilities
            ...
            sFooter = "Gedruckt am: " & Now.ToString
         ...
         If miNL = 0 Then
                MsgBox("Keine Daten im Report .", _
      ...
      Try
         ...
         If _SubTitle2.Length = 0 Then
            ...
            xPos = RightMargin - (7 * CharWidth)
                e.Graphics.DrawString("Seite: " & sPageNbr, PrintFont, Brushes.Black, xPos, yPos, New StringFormat)
         End If
         yPos += LineHeight
            ...
            Else
               Select Case ps.Format
                  ...
                  Case FormatString.DateTime
                            s = Format(dr(ps.Column), "dd.mm.yyyy hh:mm:ss tt")
